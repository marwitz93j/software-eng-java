...
public class randomNum{
	...
	public static void main(String[] args) throws IOException{
		...
		//InetAddress address = InetAddress.getByName("10.204.48.97");
		InetAddress address = InetAddress.getByName("10.204.93.149");
		ServerSocket server = new ServerSocket( 8080,50,address); //8081
